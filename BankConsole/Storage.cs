...
public static class Storage{
    ...
    public static List<User> GetNewUsers(){
        ...
        var newUsersList = listUsers.Where(user => user.GetRegisterDate().Date.Equals(DateTime.Today)).ToList(); //Expresion lambda =>
    ...
    public static bool val_id_storage(int ID){
        ...
        var storage_id_val = listUsers.SingleOrDefault(user => user.GetID() == ID);
        
        if(storage_id_val != null)
            return false;
